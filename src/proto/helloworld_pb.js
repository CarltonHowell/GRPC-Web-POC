...
if (goog.DEBUG && !COMPILED) {
   ...
   * @override
   */
  proto.helloworld.RepeatHelloRequest.displayName =
...
if (jspb.Message.GENERATE_TO_OBJECT) {
   ...
   * @return {!Object}
   */
  proto.helloworld.RepeatHelloRequest.prototype.toObject = function (
    opt_includeInstance
  ) {
    return proto.helloworld.RepeatHelloRequest.toObject(
      opt_includeInstance,
      this
    );
  };
   ...
   * @suppress {unusedLocalVariables} f is only used for nested messages
   */
  proto.helloworld.RepeatHelloRequest.toObject = function (
    includeInstance,
    msg
  ) {
    var f,
...
proto.helloworld.RepeatHelloRequest.deserializeBinary = function (bytes) {
  ...
  return proto.helloworld.RepeatHelloRequest.deserializeBinaryFromReader(
    msg,
    reader
  );
};
 ...
 * @return {!proto.helloworld.RepeatHelloRequest}
 */
proto.helloworld.RepeatHelloRequest.deserializeBinaryFromReader = function (
  msg,
  reader
) {
  while (reader.nextField()) {
 ...
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.helloworld.RepeatHelloRequest.serializeBinaryToWriter = function (
  message,
  writer
) {
  var f = undefined;
